...
try {
    ...
    foreach ($leagues as $lg) {
        ...
        foreach ($fixtures as $fx) {
            ...
            // si ya está y NO es inminente, lo saltamos
            if ($yaAnalizado && $horasParaKO > HORAS_INMINENTE) { $saltados++; continue; }
            // si ya está y es inminente, lo re-investigamos (puede haber novedades)
            $esReinvestigacion = $yaAnalizado && $horasParaKO <= HORAS_INMINENTE;
